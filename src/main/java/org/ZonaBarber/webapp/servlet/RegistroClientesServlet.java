...
public class RegistroClientesServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        clientes.setClientesNombre(nombre);
        clientes.setClientesApellido(apellido);
        clientes.setClientesDireccion(direccion);
        clientes.setClientesIdentificacion(identificacion);
        clientes.setClientesTipoIdent(tipo_identificacion);
        clientes.setClientesCelular(celular);
